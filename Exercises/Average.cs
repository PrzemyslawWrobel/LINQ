...
namespace Exercises
{
    public static class Average
    {
        ...
        */
        ...
        {
            return (snowFallData !=null && snowFallData.MonthlySnowFallDataItems != null && snowFallData.MonthlySnowFallDataItems.Count == 12) ?
        ...
        {
            return students.Any() ? students.Max(
        ...
        {
            return (heights == null || heights.Count == 0) ? 0 
                : heights.Average(height => height == null ? defaultIfNull : height.Value);
        }
